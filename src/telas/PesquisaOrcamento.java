 ...
 * @author Jeff
 */
public class PesquisaOrcamento extends javax.swing.JInternalFrame {
    ...
    private void jtbPesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtbPesquisaMouseClicked
        ...
        if (Meleca.equals("Entrada")){
            MovOrc.CarregarDados(jtbPesquisa.getValueAt(jtbPesquisa.getSelectedRow(), 0).toString());
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisaOrcamento().setVisible(true);
            }
        });
    }
    ...
    public void SetOrcamento(MovimentacaoOrcamento Mo){
        this.MovOrc = Mo;
    }
