 ...
 * @author Jeff
 */
public class CadastroMaoDeObra extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Cadastro de Mão de Obra");
    ...
    private void jbtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtSalvarActionPerformed
        ...
        Fun = new Funcoes();
        Codigo = Fun.Proximo("codigo", "t_maodeobra", "");
        ...
        Conexao.Conectar();
        Conexao.setSQL("select * from t_maodeobra where codigo = " + jtfCodigo.getText() + " and exclusao = 0");
        ResultSet RS = Conexao.Consultar();

        try {
            if(RS.next()){
                String SQL;
                SQL = "update t_maodeobra set nome = '" + jtfNome.getText() + "' where codigo = " + jtfCodigo.getText() + "";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            } else {
                String SQL;
                SQL = "insert into t_maodeobra (nome, exclusao) values('" + jtfNome.getText() + "', 0)";
                Conexao.setSQL(SQL);
                Conexao.Executar();
            }
    ...
    private void jbtPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtPesquisarActionPerformed
        ...
        PesquisaMaoDeObra A = new PesquisaMaoDeObra();
        A.setVisible(true);
    ...
    private void jbtExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtExcluirActionPerformed
        ...
        if(resposta == JOptionPane.YES_OPTION){
            ...
            String SQL = "update t_maodeobra set exclusao = 1 where codigo = '" + jtfCodigo.getText() + "'";
